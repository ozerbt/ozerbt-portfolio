...
const Skills: React.FC = () => {
    return (
        ...
        <div id="skills-container" className="w-full grid grid-cols-2  mb-[3rem] h-full">

            <div className="absolute hidden md:visible z-5 bottom-[-800px] left-[600px] md:flex justify-center ">
            ...
            <div className="relative mt-[3rem] z-99 col-span-1">
                ...
                <div className="flex flex-col w-full items-center">
                    <div className=" border-[1px_solid_rgba(0,0,0,0.06)] rounded-[10px] bg-[white] mb-10 flex flex-col items-center shadow-[2px_4px_40px_rgba(131,255,210,0.25)] w-[500px] h-[300px]">
                    ...
                    <div className=" border-[1px_solid_rgba(0,0,0,0.06)] rounded-[10px] bg-[white]  flex flex-col items-center shadow-[2px_4px_40px_rgba(131,255,210,0.25)] w-[500px] h-[300px]">
            ...
            <div className="relative mt-[3rem] z-80 col-span-1">
                <div className="flex h-full w-full items-center">
                    <div className=" border-[1px_solid_rgba(0,0,0,0.06)] rounded-[10px] bg-[white] self-center flex flex-col items-center shadow-[2px_4px_40px_rgba(131,255,210,0.25)] w-[500px] h-[300px]">
