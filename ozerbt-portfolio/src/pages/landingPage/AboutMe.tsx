...
const AboutMe: React.FC = () => {
    return (
        <div className="h-full mt-[10rem] mb-[10rem] w-full">
            <div className="bg-[#83FFD2] h-[400px] md:h-[300px] grid grid-rows-[100px_repeat(1,minmax(0,1fr))_50px] md:grid-cols-[300px_repeat(1,minmax(0,1fr))_250px]">
                ...
                <div className="flex flex-col mb-[4rem] md:mb-0 mt-[4rem] md:ml-[6rem] w-[90%]  h-[50%] self-center">
                    ...
                    <a className="button hover:cursor-pointer w-[20%] self-center text-center hover:scale-95 transition-all shadow-md bg-[#ffffff] pt-3 pb-3 pl-6 pr-6 md:pl-12 md:pr-12 rounded-[7px]"><button ><span className="inline-block mr-2 pt-1"><IoNewspaperOutline /></span>Resume</button></a>
                </div>
