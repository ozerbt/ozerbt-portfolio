                ...
                <div className="flex flex-col mb-[10rem] md:mb-0 md:mt-[4rem] md:ml-[6rem] md:w-full w-[90%]  h-[50%] self-center">
                    <div className="inline-block break-words">
                        <p className="md:text-[16px] lg:text-[24px] ml-7 md:ml-0 md:mt-10 text-center md:text-start font-semibold">
                            Hi there! My name is Behcet Ozer and I'm from Ankara, Turkey. I have a strong passion for development and enjoy exploring new ways to improve my skills in this area.
                            When I'm not working on development projects, you can usually find me enjoying a good cup of coffee, exploring the great outdoors on a hike, or cycling through the city.
                            <br />
                            <br />
                            ...
                            Whether I'm working on a new website or developing an innovative app, I find great satisfaction in using my skills to create something useful and impactful.
                        </p>
                    </div>
